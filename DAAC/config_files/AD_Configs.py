"""
AD_Configs.py
Function: Exp Config for AD dataset
History:
20241219    aihongfeng  add MHA params
"""
class Config(object):
    def __init__(self,):
        self.RANDOM_SEED = 41
        ...
        # # @ahf
        # patience multi-heads
        self.pat_multihead = True
        # trail multi-heads
        self.tra_multihead = True
        # pls ensure num_heads * head_dim = channel_dim
        self.num_heads = 2
        self.head_dim = 160
        self.channel_dim = self.output_dims
        ...
        self.finetune_epochs_10 = 27 # @ahf
        ...
        self.finetune_epochs_1 = 100 # @ahf
