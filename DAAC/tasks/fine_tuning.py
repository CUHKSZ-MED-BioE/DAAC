...
def finetune_predict(model, X_test, y_test, batch_size=128, num_classes=2, device='cuda', verbose=1):
    ...
    # first_params = next(iter(model.parameters()))
    # print("first_params:", first_params)
    with torch.no_grad():
