"""
comet.py
Function: comet with MHA
Author: aihonfeng
History:
20241219    aihongfeng  add MHA
"""
import torch
...
import numpy as np
from models import TSEncoder, MultiHeadTSEncoder, ProjectionHead
...
class COMET:
    ...
    def __init__(
        ...
        pat_multihead=False, # @lrq # @ahf Ture
        tra_multihead=False,
        num_heads=2, 
        head_dim=160, 
        channel_dim=320
    ...
    def eval_with_pooling(self, x, mask=None):
        ...
        if self.multihead:
            ...
            out = self.net(x, mask)
        # TODO check if maxpool for out and views_out seperately and the concat is better or not
